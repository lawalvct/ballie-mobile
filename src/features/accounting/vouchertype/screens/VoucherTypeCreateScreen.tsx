...
export default function VoucherTypeCreateScreen({ navigation, route }: Props) {
  ...
  const loadFormData = async () => {
    try {
      setLoading(true);
      const data = await voucherTypeService.getFormData();
      setFormData(data);
    } catch (error: any) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await voucherTypeService.create({
        name: voucherType.name,
        code: voucherType.code.toUpperCase(),
      ...
      showToast("🎉 Voucher type created successfully", "success");
      ...
      if (error.errors) {
        ...
        showToast(error.message || "Failed to create voucher type", "error");
      }
    } finally {
      setSubmitting(false);
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Voucher Type</Text>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            {submitting ? (
              ...
              <Text style={styles.submitButtonText}>Create Voucher Type</Text>
            )}
          </TouchableOpacity>
        </View>
      </ScrollView>
