...
export default function DebitNoteEntriesSection({
  ledgerAccounts,
  customerAccountId,
  customerAmount,
  debitEntries,
  ...
  return (
    <View style={styles.section}>
      <Text style={styles.sectionTitle}>Debit Note</Text>
      ...
      <View style={styles.formGroup}>
        <Text style={styles.label}>
          Debit Note Amount <Text style={styles.required}>*</Text>
        </Text>
        <TextInput
          style={styles.input}
          value={customerAmount}
          onChangeText={onCustomerAmountChange}
          placeholder="0.00"
      ...
      <View style={styles.sectionHeader}>
        <Text style={styles.subTitle}>Charge Lines (Credit)</Text>
        ...
        <View key={index} style={styles.entryCard}>
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              style={styles.input}
              value={entry.amount}
              onChangeText={(value) => onUpdateEntry(index, "amount", value)}
              placeholder="0.00"
              placeholderTextColor="#9ca3af"
              keyboardType="decimal-pad"
            />
