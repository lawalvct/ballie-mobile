...
export default function StockProductionScreen() {
  ...
  const loadFormData = async () => {
    try {
      setLoading(true);
      const formData = await stockJournalService.getFormData("production");
  ...
  const handleSubmit = async (action: "save" | "save_and_post") => {
    ...
    try {
      ...
      const payload = {
        ...
        entry_type: "production" as const,
      ...
      Alert.alert(
        ...
        action === "save_and_post"
          ? "Production entry created and posted successfully"
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Stock Production</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.infoBanner}>
          ...
          <View style={styles.infoContent}>
            <Text style={styles.infoTitle}>Production Receipt</Text>
            <Text style={styles.infoText}>
              Record finished goods received from production. Stock can be added
              or adjusted.
            </Text>
          </View>
        </View>
                  ...
                  <>
                    ...
                    <View style={styles.formGroup}>
                      ...
                      <Picker
                        ...
                        style={styles.picker}>
                        <Picker.Item label="Add Stock (In)" value="in" />
                        <Picker.Item label="Deduct Stock (Out)" value="out" />
                      </Picker>
                    </View>
                  </>
                )}
