...
export default function StockConsumptionScreen() {
  ...
  const loadFormData = async () => {
    try {
      setLoading(true);
      const formData = await stockJournalService.getFormData("consumption");
  ...
  const validateForm = (): boolean => {
    ...
    for (const item of validItems) {
      ...
      if (item.quantity > item.current_stock) {
        Alert.alert(
          "Insufficient Stock",
          `${item.product_name} has only ${item.current_stock} ${item.unit} available. Cannot consume ${item.quantity} ${item.unit}.`,
        );
        return false;
      }
    }
    ...
    try {
      ...
      Alert.alert(
        ...
        action === "save_and_post"
          ? "Consumption entry created and posted successfully"
          : "Consumption entry saved as draft",
        [
          {
            text: "OK",
      ...
      Alert.alert(
        "Error",
        error.message || "Failed to create consumption entry",
      );
    } finally {
      setSubmitting(false);
    }
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Stock Consumption</Text>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.infoBanner}>
          ...
          <View style={styles.infoContent}>
            <Text style={styles.infoTitle}>Material Consumption</Text>
            <Text style={styles.infoText}>
              Record materials consumed in production. Stock will be reduced.
            </Text>
          </View>
        </View>
