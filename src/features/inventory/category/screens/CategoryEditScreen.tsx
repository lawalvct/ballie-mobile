...
type Props = NativeStackScreenProps<InventoryStackParamList, "CategoryEdit">;
...
export default function CategoryEditScreen({ navigation, route }: Props) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [categoryResponse, formDataResponse] = await Promise.all([
        categoryService.show(id),
        categoryService.getFormData(),
      ]);
      ...
      setParentOptions(formDataResponse.parent_categories || []);
    } catch (error: any) {
            ...
            <View style={styles.switchRow}>
              <View style={styles.switchLabel}>
                ...
                <Text style={styles.helperText}>
                  {isActive
                    ? "This category is active and can be used"
