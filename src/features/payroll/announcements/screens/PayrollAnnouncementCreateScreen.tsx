...
export default function PayrollAnnouncementCreateScreen({ navigation }: Props) {
      ...
      <ScrollView style={styles.content}>
        <View style={styles.formSection}>
          ...
          <View style={styles.formGroup}>
            ...
            <View style={styles.attachmentRow}>
              <TouchableOpacity
                ...
                activeOpacity={0.85}>
                <Text style={styles.secondaryBtnText}>Pick File</Text>
              </TouchableOpacity>
              {attachment ? (
                <TouchableOpacity
                  style={styles.secondaryBtn}
          ...
          <View style={styles.actionsSection}>
            ...
            <TouchableOpacity
              style={[styles.secondaryBtn, submitting && styles.submitDisabled]}
