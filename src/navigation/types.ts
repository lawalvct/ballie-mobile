...
export type PayrollStackParamList = {
  ...
  PayrollOvertimeHome: undefined;
  PayrollOvertimeCreate: { onCreated?: () => void } | undefined;
  PayrollOvertimeShow: { id: number };
  PayrollOvertimeEdit: { id: number; onUpdated?: (id: number) => void };
  PayrollOvertimeMonthlyReport: undefined;
  PayrollSalaryAdvance: undefined;
  PayrollLoansHome: undefined;
  PayrollLoanShow: { id: number };
  PayrollAnnouncementsHome: undefined;
  PayrollAnnouncementCreate: undefined;
  PayrollAnnouncementShow: { id: number };
  PayrollAnnouncementEdit: { id: number };
